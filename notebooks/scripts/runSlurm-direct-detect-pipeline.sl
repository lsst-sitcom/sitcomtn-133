...
pipetask run -b /sdf/group/rubin/repo/aos_imsim/ -i refcats,WET-013 --instrument lsst.obs.lsst.LsstComCamSim --register-dataset-types -o WET-013/directDetectCatalog -p science_direct_detect_default_pipeline.yaml -d "detector IN (0..9) AND instrument='LSSTComCamSim'" -j 18
